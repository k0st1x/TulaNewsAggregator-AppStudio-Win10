...
{
    public class Section6Section : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public Section6Section()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://tula.sledcom.ru/news/rss_verify"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Следственный Комитет",

                    Page = typeof(Pages.Section6ListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.Section6DetailPage>(true);
                    }
                };
            }
        }
        ...
        public override DetailPageConfig<RssSchema> DetailPage
        {
            get
            {
                ...
                {
                    viewModel.PageTitle = item.PublishDate.ToString(DateTimeFormat.ShortDate);
                    viewModel.Title = item.Title.ToSafeString();
