...
{
    public class Section3Section : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public Section3Section()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://mk.tula.ru/news/rss/"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Молодой Коммунар",

                    Page = typeof(Pages.Section3ListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.Section3DetailPage>(true);
                    }
                };
            }
        }
