//---------------------------------------------------------------------------
//
// <copyright file="Section2DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Section2DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Section2DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Section2Section());
