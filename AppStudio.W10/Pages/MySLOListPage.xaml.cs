//---------------------------------------------------------------------------
//
// <copyright file="MySLOListPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class MySLOListPage : Page
    {
	    public ListViewModel ViewModel { get; set; }
        public MySLOListPage()
        {
			ViewModel = ViewModelFactory.NewList(new MySLOSection());
