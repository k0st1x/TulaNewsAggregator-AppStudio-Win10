//---------------------------------------------------------------------------
//
// <copyright file="MySLO2ListPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class MySLO2ListPage : Page
    {
	    public ListViewModel ViewModel { get; set; }
        public MySLO2ListPage()
        {
			ViewModel = ViewModelFactory.NewList(new MySLO2Section());
