//---------------------------------------------------------------------------
//
// <copyright file="Section6DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Section6DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Section6DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Section6Section());
