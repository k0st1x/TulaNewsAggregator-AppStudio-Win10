...
namespace AppStudio.ViewModels
{
    public class AboutThisAppViewModel : PageViewModelBase
    {
        ...
        {
            this.AppName = "Агрегатор новостей Тулы";
            this.Title = "NavigationPaneAbout".StringResource();
            this.Publisher = "k0st1x";
            ...
            this.AboutText = "приложение для чтения онлайн сервисов новостей города Тула и Тульской области: Сл" +
    "обода, Правительство ТО, Тульсике Новости, Молодой Коммунар, Россия 1, Центр71, " +
    "Следственный Коммитет, ТелеТула, Первый Тульский.";
            this.AppLogo = new BitmapImage(new Uri("ms-appx:///Assets/ApplicationLogo.png"));
            this.Privacy = "http://1drv.ms/1ME0lUc";
